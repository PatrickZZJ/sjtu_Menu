...
if($xml=simplexml_load_file('../xml/menu.xml')){
	foreach($xml->Xpath('/menu/category[@id="mainCourse"]/dish') as $list){
...
$lineplot1->value->SetFont(FF_SIMSUN,FS_BOLD,12);
$lineplot1->SetFillColor("#6a7d8f");
$lineplot1->SetWidth(0.6);
$lineplot1->value->Show();

$graph->Add($lineplot1);
 
$title = $getYear.'年'.$getMonth.'月'."主菜销售情况";
